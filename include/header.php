                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-primary mr-1"></i>+91 7900757561</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-primary mr-1"></i>homexmathura@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
